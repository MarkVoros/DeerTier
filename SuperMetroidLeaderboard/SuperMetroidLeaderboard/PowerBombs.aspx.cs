...
{
    public partial class PowerBombs : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            db.Connect();
            List<Score> scoreList = db.GetTimes("PowerBombsAny%");
            db.Close();
        ...
        void aspSubmitButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("AddTime.aspx?mode=powerbombs");
            }
            else
            {
                Response.Redirect("Login.aspx?redirect=powerbombs");
            }
        }
    }
}