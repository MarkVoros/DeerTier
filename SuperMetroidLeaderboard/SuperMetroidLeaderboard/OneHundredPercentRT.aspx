<%@ Page Title="100% Collection Rate" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="OneHundredPercentRT.aspx.cs" Inherits="SuperMetroidLeaderboard.OneHundredPercentRT" %>
<%@ Import Namespace="SuperMetroidLeaderboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="floatLeft">
        <h1>100% Collection Rate</h1>
    </div>
