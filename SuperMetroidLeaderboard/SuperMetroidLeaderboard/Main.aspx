...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    Hello and welcome to the <span class="deerForceFont">D e e R F o r C e</span> Hall of Fame! The aim of this site is to showcase the
    ...
    <a href="http://speedrunslive.com/"><span class="link">SpeedRunsLive</span></a> conventions. To quote the rules, this means:
    <br /><br />
    ...
    <a href="http://speedrunslive.com/gamelist/#!/supermetroid/1"><span class="link">SRL Super Metroid community</span></a>. 
