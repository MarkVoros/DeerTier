...
{
    public partial class GTCode : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            db.Connect();
            List<Score> scoreList = db.GetTimes("Any%GTCode");
            db.Close();
        ...
        void aspSubmitButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("AddTime.aspx?mode=gtcode");
            }
            else
            {
                Response.Redirect("Login.aspx?redirect=gtcode");
            }
        }
    }
}