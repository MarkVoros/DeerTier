...
{
    public partial class LowPercentIceBeam : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            db.Connect();
            List<Score> scoreList = db.GetTimes("Low%Ice");
            db.Close();
        ...
        void aspSubmitButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("AddTime.aspx?mode=lowpercentice");
            }
            else
            {
                Response.Redirect("Login.aspx?redirect=lowpercentice");
            }
        }
    }
}