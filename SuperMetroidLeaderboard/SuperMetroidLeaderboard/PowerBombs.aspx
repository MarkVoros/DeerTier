<%@ Page Title="Power Bombs Any% Route" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PowerBombs.aspx.cs" Inherits="SuperMetroidLeaderboard.PowerBombs" %>
<%@ Import Namespace="SuperMetroidLeaderboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="floatLeft">
        <h1>Power Bombs Any% Route</h1>
    </div>
