<%@ Page Title="Low% Ice Beam Route" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="LowPercentIceBeam.aspx.cs" Inherits="SuperMetroidLeaderboard.LowPercentIceBeam" %>
<%@ Import Namespace="SuperMetroidLeaderboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="floatLeft">
        <h1>Low% Ice Beam Route</h1>
    </div>
