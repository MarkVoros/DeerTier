<%@ Page Title="Low% Speed Booster Route" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="LowPercentSpeedBooster.aspx.cs" Inherits="SuperMetroidLeaderboard.LowPercentSpeedBooster" %>
<%@ Import Namespace="SuperMetroidLeaderboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="floatLeft">
        <h1>Low% Speed Booster Route</h1>
    </div>
