<%@ Page Title="100% Map Completion" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="OneHundredPercentMapCompletion.aspx.cs" Inherits="SuperMetroidLeaderboard.OneHundredPercentMapCompletion" %>
<%@ Import Namespace="SuperMetroidLeaderboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="floatLeft">
        <h1>100% Map Completion</h1>
    </div>
